...
const (
	UserRpc_Ping_FullMethodName = "/user.user_rpc/ping"
)
...
func (c *userRpcClient) Ping(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
...
func (UnimplementedUserRpcServer) Ping(context.Context, *Ping) (*Pong, error) {
...
func _UserRpc_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRpcServer).Ping(ctx, req.(*Ping))
	}
