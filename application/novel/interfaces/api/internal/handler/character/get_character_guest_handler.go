...
// 获取小说角色信息(游客)
func GetCharacterGuestHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := character.NewGetCharacterGuestLogic(r.Context(), svcCtx)
		resp, err := l.GetCharacterGuest(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
