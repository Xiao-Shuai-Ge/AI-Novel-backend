...
// 获取小说篇章列表(游客)
func GetChapterListGusetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := chapter.NewGetChapterListGusetLogic(r.Context(), svcCtx)
		resp, err := l.GetChapterListGuset(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
